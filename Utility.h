...
String return_reset_reason(RESET_REASON reason)
{
  ...
  switch ( reason)
  {
    case 1 : Reason = "POWERON_RESET"; break;         /**<1, Vbat power on reset*/
    case 3 : Reason = "SW_RESET"; break;              /**<3, Software reset digital core*/
    case 4 : Reason = "OWDT_RESET"; break;            /**<4, Legacy watch dog reset digital core*/
    case 5 : Reason = "DEEPSLEEP_RESET"; break;       /**<5, Deep Sleep reset digital core*/
    case 6 : Reason = "SDIO_RESET"; break;            /**<6, Reset by SLC module, reset digital core*/
    case 7 : Reason = "TG0WDT_SYS_RESET"; break;      /**<7, Timer Group0 Watch dog reset digital core*/
    ...
    case 15 : Reason = "RTCWDT_BROWN_OUT_RESET"; break; /**<15, Reset when the vdd voltage is not stable*/
    case 16 : Reason = "RTCWDT_RTC_RESET"; break;     /**<16, RTC Watch dog reset digital core and rtc module*/
